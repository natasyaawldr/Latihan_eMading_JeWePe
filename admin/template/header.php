...
>
  <head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.1/css/all.min.css" integrity="sha512-xr2TajH0StEnB8nhLJKFvptHCrKw5cg40R2S1jMy5K/qr6Y2doWlSX+snGCvUJtCweV+1vVyxG2nRjcKOO1bkQ==" crossorigin="anonymous" />
            ...
            <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
              ...
              <div class="navbar-nav align-items-center">
                <div class="nav-item d-flex align-items-center">
                 Halaman Admin e-Mading JeWePe <a href="../index.php" target="blank" class="ms-3 btn btn-sm  btn-icon btn-outline-primary">
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="d-flex">
                          <div class="flex-shrink-0 me-3">
                            <div class="avatar avatar-online">
                              <img src="../../assets/landing/images/icon.png" alt class="w-px-40 h-auto rounded-circle" />
                            </div>
                          </div>
                          <div class="flex-grow-1">
                            <span class="fw-semibold d-block">Natasya Wuladari</span>
